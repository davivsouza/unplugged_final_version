...
import { binauralSoundsScreenSlides } from '@utils/slides'
...
export function BinauralSoundsIntroSlider() {
    ...
    return (
        <ScreenContainer>
            <Carousel
                data={binauralSoundsScreenSlides}
